...
public class AdminController {
	...
	public ResponseEntity<List<Planter>> getPlantersHandler(@PathVariable("loginId")String uuid) {
	...
	public ResponseEntity<List<Planter>> getPlantersByCostRangeHandler(@PathVariable("loginId")String uuid,@PathVariable("min")Double min,@PathVariable("max")Double max) {
